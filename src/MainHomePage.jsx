...
// Fonction utilitaire pour tronquer le texte à 22 caracteres max
...
function Annonce({ annonce }) {
    const truncatedTitle = truncateText(annonce.nom_de_l_annonce, 22);
...
function MainHomePage({ searchResults }) {
    return (
        <main>
